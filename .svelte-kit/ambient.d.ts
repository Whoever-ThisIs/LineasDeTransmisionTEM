...
declare module '$env/static/private' {
	...
	export const ANSYS231_DIR: string;
	export const APPDATA: string;
	export const AWP_LOCALE231: string;
	export const AWP_ROOT231: string;
	export const CABAL_DIR: string;
	export const CADOE_LIBDIR231: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		ANSYS231_DIR: string;
		APPDATA: string;
		AWP_LOCALE231: string;
		AWP_ROOT231: string;
		CABAL_DIR: string;
		CADOE_LIBDIR231: string;
		COLORTERM: string;
